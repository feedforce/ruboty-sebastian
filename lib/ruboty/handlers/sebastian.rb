module Ruboty
  module Handlers
    class Sebastian < Base
      ...
      on /greet before close/, name: 'greet_before_closing', description: 'Output greeting message before close of business'
      on /greet close/, name: 'greet_at_closing', description: 'Output greeting message for close of business'
